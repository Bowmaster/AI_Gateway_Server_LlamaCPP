...
pip install fastapi uvicorn requests rich psutil httpx
...
packages = ['llama-cpp-python', 'fastapi', 'uvicorn', 'requests', 'rich', 'huggingface-hub', 'httpx', 'duckduckgo-search', 'beautifulsoup4', 'lxml']
